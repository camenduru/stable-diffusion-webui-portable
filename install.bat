...
@CALL set TORCH_VERSION=2.0.0+11.8
...
@CALL echo Clone Stable-Diffusion-WebUI...
@CALL git clone -b %BRANCH% %SDDEPOT% %WEBUI_LOACTION%
@CALL echo CLONE STABLE-DIFFUSION-WEBUI... DONE
...
@CALL echo CLONE BASE PLUGINS... DONE

@REM DOWNLOADING BASE MODELS...
@CALL echo DOWNLOADING MODELS...
@CALL echo Dowloading Stable-Diffusion Model: AnythingV5Ink_v5PrtRE.safetensors
...
@CALL echo Dowloading Embeddings Model: EasyNegative.safetensors
...
@CALL echo Dowloading VAE model: vae-ft-mse-840000-ema-pruned.safetensors
