...
@REM @CALL git clone https://github.com/Jeffreytsai1004/CompVis-stable-diffusion.git %WEBUI_LOACTION%\repositories\stable-diffusion
@REM @CALL git clone https://github.com/Jeffreytsai1004/taming-transformers.git %WEBUI_LOACTION%\repositories\taming-transformers
@REM @CALL git clone https://github.com/Jeffreytsai1004/k-diffusion.git %WEBUI_LOACTION%\repositories\k-diffusion
@REM @CALL git clone https://github.com/Jeffreytsai1004/CodeFormer.git %WEBUI_LOACTION%\repositories\CodeFormer
@REM @CALL git clone https://github.com/Jeffreytsai1004/BLIP.git %WEBUI_LOACTION%\repositories\BLIP

@REM @REM DOWNLOADING BASE MODELS...
@REM @CALL curl -L https://huggingface.co/embed/EasyNegative/resolve/main/EasyNegative.safetensors -o %WEBUI_LOACTION%\embeddings\EasyNegative.safetensors
@REM @CALL curl -L https://huggingface.co/Toooajk/YaguruMagiku/resolve/main/YaguruMagiku-v4/embeddings/yaguru%20magiku.pt -o %WEBUI_LOACTION%\embeddings\yaguru%20magiku.pt
